...
?>
		...
		if(mysqli_num_rows($qu_gen_clients_EXE)){
			...
			$client_nameT = $gen_clients_DATA['client_name'];
			
		
				
				?>
						<option value="<?=$job_order_id; ?>"><?=$job_order_ref; ?> - <?=$client_nameT; ?></option>
				<?php
		}
				}
			}
...
<div class="viewerBodyButtons">
		...
		<?php
			if( $bill_status != 'invoice_created' ){
		?>
		<a href="acc_new_invoice.php?bill_id=<?=$bill_id; ?>"><button type="button">
			<?=lang('Create_Invoice', 'ARR', 1); ?>
		</button></a>
		<?php
