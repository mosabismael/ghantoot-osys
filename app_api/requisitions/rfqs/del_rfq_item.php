<?php
	...
	try{
		if( isset($_POST['rfq_item_id']) ){
			...
			$qu_pur_requisitions_rfq_items_sel = "SELECT * FROM  `pur_requisitions_rfq_items` WHERE `rfq_item_id` = $rfq_item_id";
			...
			$qu_pur_requisitions_rfq_items_del = "DELETE FROM `pur_requisitions_rfq_items` WHERE `rfq_item_id` = $rfq_item_id";
			$deleteStatement = mysqli_prepare($KONN,$qu_pur_requisitions_rfq_items_del);
