...
$site_logo =  "";
	...
	if( !isset( $_GET['idd'] ) ){
		...
		$deduction_id = (int) test_inputs( $_GET['idd'] );
	}
	...
	$qu_hr_employees_deductions_sel = "SELECT * FROM  `hr_employees_deductions` WHERE `deduction_id` = $deduction_id";
	...
	if(mysqli_num_rows($qu_hr_employees_deductions_EXE)){
		$hr_employees_deductions_DATA = mysqli_fetch_assoc($qu_hr_employees_deductions_EXE);
	}
		$deduction_date = $hr_employees_deductions_DATA['deduction_date'];
		$deduction_effective_date = $hr_employees_deductions_DATA['deduction_effective_date'];
		$deduction_amount = $hr_employees_deductions_DATA['deduction_amount'];
		$memo = $hr_employees_deductions_DATA['memo'];
		$employee_id = $hr_employees_deductions_DATA['employee_id'];
...
<div style="width: 50%;text-align: left;">
	<div style="text-align:left;font-size: 14px;font-weight: 600;width:100%;margin: 0 auto;margin: 0;" id="bcTarget">
        ...
        <th style="width:33.33%;text-align: right;">
			<h1 style="font-size: 18pt;padding: 0;margin:0;color: #33611e;">EMPLOYEE DEDUCTION</h1>
  ...
  <tbody>
	...
	<h3>EMPLOYEE DEDUCTION DETAILS</h3>
...
<tr>
	...
	<td style = "width:33.33%;font-size: 14pt;"><?=$deduction_date; ?></td>
</tr>

<tr>
         <td style="width:33.33%;color: #33611e;font-size: 14pt;font-weight: bold;">Effective Date</td>
	<td style = "width:33.33%;font-size: 14pt;"><?=$deduction_effective_date; ?></td>
</tr>

<tr>
         <td style="width:33.33%;color: #33611e;font-size: 14pt;font-weight: bold;">Amount</td>
	<td style = "width:33.33%;font-size: 14pt;" ><?=number_format($deduction_amount, 3); ?></td>
</tr>
	<tr>
         <td style="width:33.33%;color: #33611e;font-size: 14pt;font-weight: bold;">Current Status</td>
	<td style = "width:33.33%;font-size: 14pt;"><?=$deduction_status; ?></td>
</tr>
<tr>
...
<tr>
         <td style="width:33.33%;color: #33611e;font-size: 14pt;font-weight: bold;">Status Change Updates</td>
</tr>
...
<table style="width: 100%;margin:0 auto;">
	...
	<tbody>
<?php
	$qu_gen_status_change_sel = "SELECT * FROM  `gen_status_change` WHERE `item_type` = 'hr_employees_deductions' AND `item_id` = $deduction_id ORDER BY `status_id` ASC";
