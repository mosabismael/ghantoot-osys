<?php
	...
	$showPerPage = 20;
	$totPages = 0;
	$qu_COUNT_sel = "SELECT count(*) FROM  `purchase_orders`  WHERE ( ( (`po_status` = 'activated') OR (`po_status` = 'pending_approval') ) AND (`approved_by` = '$EMPLOYEE_ID')  $SERCHCOND )";
...
<html dir="<?=$lang_dir; ?>" lang="<?=$lang; ?>">
	...
	<body>
		...
		<div class = "history" id = "history" style = "height: 300px;margin-top: -5%;margin-left: 1.5%;overflow:auto;">
			History
