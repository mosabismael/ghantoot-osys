<?php
	...
	$sNo = $start + 1;
	$qu_inv_mrvs_sel = "SELECT * FROM  `inv_mrvs` WHERE ((`mrv_status` = 'inspection_required') AND ( `inspected_by` = '$EMPLOYEE_ID' ) $serchCond) ORDER BY `mrv_id` DESC LIMIT $start,$per_page";

	//echo $qu_inv_mrvs_sel;
