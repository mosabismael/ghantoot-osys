<?php
	...
	$sNo = $start + 1;
	$qu_purchase_orders_sel = "SELECT * FROM  `purchase_orders` WHERE ( ( (`po_status` = 'activated') OR (`po_status` = 'pending_approval') ) AND (`approved_by` = '$EMPLOYEE_ID') ) ORDER BY `po_id` ASC LIMIT $start,$per_page";
