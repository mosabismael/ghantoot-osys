<?php
	...
	$sNo = $start + 1;
	$qu_pur_requisitions_sel = "SELECT * FROM  `pur_requisitions` WHERE ((`requisition_status` = 'archive') AND (`ordered_by` = '$EMPLOYEE_ID') $serchCond ) ORDER BY `requisition_id` DESC LIMIT $start,$per_page";
