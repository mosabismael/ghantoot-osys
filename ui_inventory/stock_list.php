				...
				<div class="tableForm">
					<div class="tableFormGroup">
						<select id = "search_option">
							...
							<option value = "5">Placement-Area</option>
							<option value = "6">Placement-Rack</option>
							<option value = "7">Placement-Shelf</option>
						</select>
				...
				<table id="dataTable" class="tabler" border="2" style="font-size:10px;">
					<thead>
						<tr>
							...
							<th rowspan="2" style="width:15%;"><?=lang("Supplier", "AAR"); ?></th>
							<th rowspan="2" style="width:30%;"><?=lang("Item", "AAR"); ?></th>
							<th rowspan="2"><?=lang("Qty", "AAR"); ?></th>
							<th rowspan="2"><?=lang("UOM", "AAR"); ?></th>
							<th colspan="3"><?=lang("Placement", "AAR"); ?></th>
							<th rowspan="2"><?=lang("Options", "AAR"); ?></th>
						</tr>
						<tr>
							<th><?=lang("Area", "AAR"); ?></th>
							<th><?=lang("Rack", "AAR"); ?></th>
						...
						<?php
							...
							if(mysqli_num_rows($qu_inv_stock_EXE)){
								...
								<tr id="po-<?=$stock_id; ?>">
									...
									<td><?=$shelf_name; ?></td>
									<td>
										<a href="stock_list_placement.php?stock_id=<?=$stock_id; ?>"><button type="button"><?=lang("Location", "AAR"); ?></button></a>
									</td>
								</tr>
								<?php
								}
