<?php
	...
	$qu_boq_sel = "SELECT SUM(total_cost) as total from z_manhour_detail where boq_id = '".$boq_id."';";
	$qu_boq_EXE = mysqli_query($KONN, $qu_boq_sel);
	...
	$qu_project_level1_ins = "DELETE FROM z_manhour_detail where boq_id = '".$boq_id."';";
