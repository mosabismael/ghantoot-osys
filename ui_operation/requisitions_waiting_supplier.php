<?php
	...
	$showPerPage = 20;
	$totPages = 0;
	$qu_pur_requisitions_sel = "SELECT COUNT(`requisition_id`) FROM  `pur_requisitions`  WHERE ( (`requisition_status` = 'waiting_supplier') AND (`ordered_by` = '$EMPLOYEE_ID')  $SERCHCOND )";
