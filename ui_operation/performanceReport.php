<?php
	...
	$IAM_ARRAY;
				$sNo = $OFFSET ;
				$qu_pur_requisitions_sel = "SELECT item.item_name, stock.qty, inmiv.created_date as invoicedate , mrv.created_date as receiveddate ,DATEDIFF(inmiv.created_date , mrv.created_date) as date FROM inv_stock stock , inv_mrvs mrv,inv_mivs inmiv , inv_mivs_items mivitems ,inv_06_codes item where stock.category_id = item.code_id and mrv.mrv_id = stock.mrv_id and mivitems.stock_id = stock.stock_id and mivitems.miv_id = inmiv.miv_id limit 10;" ;
				$newobj ;
