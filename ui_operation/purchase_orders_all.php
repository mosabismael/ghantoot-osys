					...
					<div class="table">
						<div class="tableHeader">
							<div class="tr">
								...
								<div class="th"><?=lang("Requsition", "AAR"); ?></div>
					...
					<script>
						...
						function bindData( response ){
							...
							for( i=0 ; i < response.length ; i ++ ){
								...
								'	<div class = "td" onclick="showReqDetails(' + response[i].requisition_id + ", '" + response[i].requisition_ref  + "'" +  ", 'viewItemDetails'" + ');"><span id="joREF-'+response[i].requisition_id +'" class="text-primary cursored">' + response[i].requisition_ref + '</span></div>' + 
