<?php
	...
	$showPerPage = 20;
	$totPages = 0;
	$qu_pur_requisitions_sel = "SELECT COUNT(`requisition_id`) FROM  `pur_requisitions`  WHERE ( (`requisition_status` <> 'deleted') AND (`ordered_by` = '$EMPLOYEE_ID') $SERCHCOND )";
			...
			<div class="col-100">
				...
				<div class="tableHolder">
					...
					<div class="tableForm">
						<div class="tableFormGroup">
							<select id = "search_option">
								...
								<option value = "requisition_status">Status</option>
							</select>
					...
					<div class="tablePagination">
						<div class="pageNum arrowPager" id="prePatchBtn" onclick="showPrePageBatch('ui_operation/requisitions_my.php', <?=$showPerPage; ?>, <?=$totPages; ?>);"><i class="fas fa-angle-double-left"></i></div>
						<?php
							for( $i=$page ; $i<$page+10 ; $i++ ){
								...
								if( $i <= $totPages ){
								?>
								<div onclick="loadTableData( <?=$i; ?>, <?=$showPerPage; ?>, 'ui_operation/requisitions_my.php' );" class="pageNum imVarPager pn-<?=$i; ?> <?=$CLS; ?>"><?=$iView; ?></div>
								<?php
								}
							}
						?>
						<div id="addPagerPoint"></div>
						<div class="pageNum arrowPager" id="nextPatchBtn" onclick="showNextPageBatch('ui_operation/requisitions_my.php', <?=$showPerPage; ?>, <?=$totPages; ?>);"><i class="fas fa-angle-double-right"></i></div>
					</div>
					<script>
